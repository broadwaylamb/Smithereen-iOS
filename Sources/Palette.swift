...
struct Palette {
    ...
    static let vk: Palette = .init(
        name: "VK",
        accent: #colorLiteral(red: 0.3432503939, green: 0.5199017525, blue: 0.7226997614, alpha: 1),
        feedBackground: #colorLiteral(red: 0.9191012979, green: 0.9336467385, blue: 0.9507810473, alpha: 1),
